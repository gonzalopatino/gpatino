export interface BlogPost {
  ...
  date: string
  readTime: string
  category: 'AI/ML' | 'Software Engineering' | 'Career' | 'Tutorials' | 'Industry'
  tags: string[]
  featured: boolean
  image?: string
}
...
export const blogPosts: BlogPost[] = [
  {
    id: '1',
    slug: 'building-production-ready-llm-applications',
    title: 'Building Production-Ready LLM Applications: Lessons from the Trenches',
    excerpt: 'After deploying multiple LLM-powered features to production, here are the critical lessons I learned about reliability, cost optimization, and user experience.',
    content: `
...
Production LLM applications require the same rigor as any production system, plus domain-specific considerations for cost, latency, and non-determinism. Start with these foundations, and you'll avoid the most common pitfalls.
    ...
    readTime: '8 min read',
    category: 'AI/ML',
    tags: ['LLM', 'Production', 'Best Practices', 'Python'],
    featured: true,
  },
  {
    id: '2',
    slug: 'modern-api-design-patterns-2025',
    title: 'Modern API Design Patterns for 2025: Beyond REST',
    excerpt: 'REST served us well, but modern applications demand more. Explore GraphQL, gRPC, and hybrid approaches for building APIs that scale.',
    content: `
...
The best API is one your team can maintain and your users can understand.
  ...
  {
    id: '3',
    slug: 'from-embedded-to-ai-engineering',
    title: 'From Embedded Systems to AI Engineering: A Career Transition Guide',
    excerpt: 'How skills from embedded development translate to AI engineering, and what you need to learn to make the switch.',
    content: `
## The Unexpected Path
...
The industry needs engineers who can deploy ML to real devices. Your background is a feature, not a bug.
    ...
    readTime: '7 min read',
    category: 'Career',
    tags: ['Career', 'Embedded', 'AI/ML', 'Transition'],
    featured: false,
  },
  {
    id: '4',
    slug: 'effective-code-review-practices',
    title: 'Effective Code Review Practices for AI/ML Teams',
    excerpt: 'Code review for ML projects requires special attention to data handling, experiment tracking, and reproducibility. Here is how to do it right.',
    content: `
...
Good code review makes ML projects reproducible, reliable, and maintainable. Invest in the process.
    ...
    readTime: '6 min read',
    category: 'Software Engineering',
    tags: ['Code Review', 'ML', 'Best Practices', 'Teams'],
    featured: false,
  },
  {
    id: '5',
    slug: 'real-time-ml-inference-at-scale',
    title: 'Real-Time ML Inference at Scale: Architecture Patterns',
    excerpt: 'Serving ML models with sub-100ms latency at thousands of requests per second requires careful architecture. Here are the patterns that work.',
    content: `
...
Real-time ML at scale is an engineering challenge as much as a modeling one. Invest in your serving infrastructure.
    ...
    readTime: '9 min read',
    category: 'AI/ML',
    tags: ['ML Ops', 'Infrastructure', 'Scaling', 'Production'],
    featured: true,
  },
]
