...
export const projects: Project[] = [
  {
    ...
    summary: 'Production-grade IoT thermostat system with real-time sensor fusion, PID control, and secure MQTT cloud connectivity.',
    ...
    role: 'Solo Engineer. Designed architecture, implemented embedded firmware, cloud integration, and full system testing.',
    stack: ['C/C++', 'FreeRTOS', 'ESP-IDF', 'MQTT', 'WiFi', 'I2C/SPI', 'PID Control', 'Sensor Fusion'],
    metrics: [
  ...
  },
  {
    ...
    category: 'ML & Autonomous Systems',
    ...
    solution: 'Built an integrated drone ecosystem: FreeRTOS-based flight controller handles real-time stabilization and RF communication. ML models optimize flight parameters and enable autonomous behaviors. VR interface provides immersive first-person control with gesture recognition.',
    role: 'Solo Engineer. Designed full-stack architecture from embedded flight controller to ML pipeline and VR interface.',
